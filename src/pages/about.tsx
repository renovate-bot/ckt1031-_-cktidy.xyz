    ...
    <>
      ...
      <div className="mt-5 flex flex-col items-center">
        ...
        <div className="mb-10 mt-3 w-full space-y-6 text-left">
          ...
          <p>
            I love reading, writing, and coding. I enjoy investigating philosophical questions and
            the intersection between technology and ethics
          </p>
          <p>
            I am passionate about exploring ideas and discussing them with others, and I enjoy
            sharing my thoughts and knowledge with people online.
          </p>
          <p>
            Additionally, I find programming to be a fascinating way to create and problem-solve,
            and I love the feeling of accomplishment that comes from building something new and
            useful with code.
          </p>
